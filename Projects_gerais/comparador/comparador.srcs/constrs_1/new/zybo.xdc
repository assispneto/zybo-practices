...
#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { load }]; #IO_L24N_T3_34 Sch=BTN1
...
##LEDs
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { dout[0] }]; #IO_L23P_T3_35 Sch=LED0
