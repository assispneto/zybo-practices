...
architecture STRUCTURE of design_1 is
  ...
  signal cpu_0_d_out_vga : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  signal cpu_0_dbg_sp : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal cpu_0_dbg_state : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal cpu_0_flag_status : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal cpu_0_led : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal dout_in_0_1 : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal ram_0_dout : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk_cpu : signal is "XIL_INTERFACENAME CLK.CLK_CPU, ASSOCIATED_RESET rst, CLK_DOMAIN design_1_clk_cpu, FREQ_HZ 100000000, PHASE 0.000";
...
begin
  ...
  clk_0_1 <= clk_cpu;
  dout_in_0_1(3 downto 0) <= dout_in(3 downto 0);
  led_0(3 downto 0) <= cpu_0_led(3 downto 0);
  rst_0_1 <= rst;
cpu_0: component design_1_cpu_0_0
     port map (
      IR_data(15 downto 0) => rom_0_dout(15 downto 0),
      RAM_we => cpu_0_RAM_we,
      ROM_addr(15 downto 0) => Net(15 downto 0),
      ROM_en => cpu_0_ROM_en,
      clk => clk_0_1,
      d_out_vga(15 downto 0) => cpu_0_d_out_vga(15 downto 0),
      ...
      dbg_sp(15 downto 0) => cpu_0_dbg_sp(15 downto 0),
      dbg_state(3 downto 0) => cpu_0_dbg_state(3 downto 0),
      dout_in(3 downto 0) => dout_in_0_1(3 downto 0),
      flag_status(1 downto 0) => cpu_0_flag_status(1 downto 0),
      led(3 downto 0) => cpu_0_led(3 downto 0),
      ram_addr(15 downto 0) => cpu_0_ram_addr(15 downto 0),
      ram_din(15 downto 0) => ram_0_dout(15 downto 0),
...
cpu_vga_dbg_0: component design_1_cpu_vga_dbg_0_0
     port map (
      ...
      PC(15 downto 0) => Net(15 downto 0),
      SP_reg(15 downto 0) => cpu_0_dbg_sp(15 downto 0),
      clk => clk50MHz_0_1,
      dout(7 downto 0) => cpu_vga_dbg_0_dout(7 downto 0),
      dout_vga(15 downto 0) => cpu_0_d_out_vga(15 downto 0),
      flag_status(1 downto 0) => cpu_0_flag_status(1 downto 0),
...
ram_0: component design_1_ram_0_0
     port map (
      address(9 downto 0) => cpu_0_ram_addr(9 downto 0),
      clk => clk_0_1,
      din(15 downto 0) => cpu_0_ram_dout(15 downto 0),
      dout(15 downto 0) => ram_0_dout(15 downto 0),
      we => cpu_0_RAM_we
    );
rom_0: component design_1_rom_0_0
     port map (
      address(9 downto 0) => Net(9 downto 0),
      clk => clk_0_1,
