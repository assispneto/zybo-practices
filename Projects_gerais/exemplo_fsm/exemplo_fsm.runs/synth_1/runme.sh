...
HD_PWD='C:/Users/assis/exemplo_fsm/exemplo_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_leds.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_leds.tcl
