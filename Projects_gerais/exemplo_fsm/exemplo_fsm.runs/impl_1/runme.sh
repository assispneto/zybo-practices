...
HD_PWD='C:/Users/assis/exemplo_fsm/exemplo_fsm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_leds.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_leds.tcl -notrace
